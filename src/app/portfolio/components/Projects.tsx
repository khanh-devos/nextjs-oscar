    ...
    >
      {
        ...
        <div className="my-10" key={uuidv4()}>
          ...
          <Reflection light={false} border={true} borderColor="skyblue" borderShiningColor='orange' borderWidth={6} angle={100} color="lightgreen" sideColor="darkgreen" borderRadius='10px' borderPathScale={2.5} borderRadiusRatio={1.4}>
